-- Fix drip campaign display functions

-- Update the count_contact_drip_campaigns_batch function to only count active campaigns
...
-- Update the get_contact_drip_campaigns function to include more status information
